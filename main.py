...
title = Label(entries_frame, text="Employee Management System", font=("Calibri", 18, "bold"), bg="black", fg="white")
title.grid(row=0, columnspan=2, padx=10, pady=20, sticky="w")

lblName = Label(entries_frame, text="Name", font=("Calibri", 16), bg="black", fg="white")
lblName.grid(row=1, column=0, padx=10, pady=10, sticky="w")
txtName = Entry(entries_frame, textvariable=name, font=("Calibri", 16), width=30)
txtName.grid(row=1, column=1, padx=10, pady=10, sticky="w")

lblAge = Label(entries_frame, text="Age", font=("Calibri", 16), bg="black", fg="white")
lblAge.grid(row=1, column=2, padx=10, pady=10, sticky="w")
txtAge = Entry(entries_frame, textvariable=age, font=("Calibri", 16), width=30)
txtAge.grid(row=1, column=3, padx=10, pady=10, sticky="w")

lbldoj = Label(entries_frame, text="D.O.J", font=("Calibri", 16), bg="black", fg="white")
...
#lbldoj = Label(entries_frame, text="Date of Birth", font=label_font, bg="black", fg="white")
#lbldoj.grid(row=2, column=0, padx=10, pady=10, sticky="w")
#txtDoj = Entry(entries_frame, font=("Calibri", 16), width=30, background='darkblue',
# foreground='white', borderwidth=2, year=datetime.datetime.now().year - 100)
#txtDoj.grid(row=2, column=1, padx=10, pady=10, sticky="w")

lblEmail = Label(entries_frame, text="Email", font=("Calibri", 16), bg="black", fg="white")
lblEmail.grid(row=2, column=2, padx=10, pady=10, sticky="w")
txtEmail = Entry(entries_frame, textvariable=email, font=("Calibri", 16), width=30)
txtEmail.grid(row=2, column=3, padx=10, pady=10, sticky="w")

lblGender = Label(entries_frame, text="Gender", font=("Calibri", 16), bg="black", fg="white")
...
lblContact = Label(entries_frame, text="Contact No", font=("Calibri", 16), bg="black", fg="white")
...
lblAddress = Label(entries_frame, text="Address", font=("Calibri", 16), bg="black", fg="white")
...
def add_function():
    ...
    if not match:
        messagebox.showerror("Error", "Invalid date format. Please enter a date in the format YYYY-MM-DD.")
        return

    # Validate email
    email_string = email.get()
    ...
    if not match:
        ...
        contact_string = contact.get()
        match = re.search(contact_regex, contact_string)
        if not match:
            messagebox.showerror("Error", "Invalid contact number. Please enter a valid 10-digit contact number.")
            return

        # Add employee data to database
        db.add_data(name.get(), age.get(), doj.get(), gender.get(), email.get(), contact.get())
